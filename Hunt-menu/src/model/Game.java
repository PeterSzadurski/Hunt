...
public class Game {
	...
	public static String magicEffectColor = "#9e00d8";
	...
	// Generate items
	public static Item smallPotion = new Item("Small Potion", 'i', "<span style = \"color:" + buffColor + "\">Restores</span> 10HP", 10, Effect.RESTORE_HEALTH);
	public static Item largePotion = new Item("Large Potion", 'i', "<span style = \"color:" + buffColor + "\">Restores</span> 50HP", 50, Effect.RESTORE_HEALTH);
	public static Item smallPoison = new Item("Small Poison", 'i', "<span style = \"color:" + debuffColor + "\">Damages</span> 15HP", 15, Effect.DAMAGE_HEALTH);
	public static Item scrollTeleportation = new Item("Scroll of Teleportation", 'i', "<span style = \"color: "+ magicEffectColor + "\">Teleports</span> the user", 0, Effect.TELEPORT);
